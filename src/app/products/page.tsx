  ...
  return (
    <div className="flex h-screen">
      <div className="flex-1 p-6 overflow-auto">
        <h2 className="text-3xl font-semibold text-[#fe6c00] mb-4">All Products</h2>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2 text-white bg-[#fe6c00] hover:bg-orange-600 rounded-md"
                >
